...
namespace NutriBem.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,IngredienteQuantidade,MododePreparo,Observacoes,Calorias,Curtidas")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,IngredienteQuantidade,MododePreparo,Observacoes,Calorias,Curtidas")] Receita receita)
        {
            if (id != receita.Id)
            {
                return NotFound();
